...
describe('CPU effect-aware evaluation', () => {
  it('rates a character with onPlay KO higher than a vanilla character', () => {
    const koChar = makeCharacterDef({ cardDefinitionId: 'OP09-009', cardNumber: 'OP09-009', baseCost: 4, basePower: 5000 });
    ...
    const foe = makeCharacterDef({ cardNumber: 'FOE', baseCost: 3, basePower: 4000 });
