...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary: 'border-[rgb(var(--op-gold-rgb)/0.6)] text-white hover:border-[rgb(var(--op-gold-rgb))] hover:bg-[rgb(var(--op-gold-rgb)/0.1)] disabled:text-white/40',
  secondary: 'border-white/30 text-white/85 hover:border-white/60 hover:bg-white/10 disabled:text-white/40',
  ghost: 'border-transparent text-white/75 hover:border-white/25 hover:bg-white/5 disabled:text-white/40',
