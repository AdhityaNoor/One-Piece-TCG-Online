...
export function PileStack({ label, count, variant, onClick }: PileStackProps) {
  return (
    <div className="flex flex-shrink-0 flex-col items-center gap-0.5">
      <button
        ...
        className={[
          'relative flex items-center justify-center rounded-md border bg-gradient-to-br text-[10px] font-extrabold text-white/70 shadow-[0_4px_10px_rgba(0,0,0,0.3)] transition-transform',
