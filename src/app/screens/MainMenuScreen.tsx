...
export function MainMenuScreen() {
  ...
  return (
    <GameCanvasScreen
      ...
      status="Alpha client"
      title={
        <span className="flex flex-col items-center pt-[clamp(2rem,8vh,6rem)]" aria-label="One Piece Online">
          <span
            aria-hidden="true"
            className="block h-[4.7rem] w-[min(82vw,36rem)] bg-[linear-gradient(180deg,_#ffe17a_0%,_#d9a441_50%,_#8e5b12_100%)] drop-shadow-[0_7px_0_rgba(0,0,0,0.65)] sm:h-[6.6rem] sm:w-[min(76vw,48rem)] md:h-[8rem] md:w-[min(72vw,58rem)]"
            style={{
          ...
          />
          <span className="mt-5 block text-[0.42em] tracking-[0.22em] text-gold drop-shadow-[0_4px_0_rgba(0,0,0,0.65)]">Online</span>
        </span>
      }
      topRight={
        <button
    ...
    >
      <div className="relative flex h-full items-start justify-center overflow-hidden pt-2">
