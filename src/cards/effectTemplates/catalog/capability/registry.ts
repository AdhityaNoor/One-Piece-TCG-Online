...
export const EFFECT_PRIMITIVES: Record<AbilityFunction['fn'], CapabilitySpec> = {
  ...
  koImmunitySelf: {
    ...
    covers: ['this Character cannot be K.O.\'d in battle', 'this Character cannot be K.O.\'d by your opponent\'s effects'],
    examples: [{ cardNumber: 'OP06-012', snippet: "{ fn: 'koImmunitySelf', scope: 'battle', duration: 'permanent', condition: { gate: [...] } }" }],
  },
  koImmunityControllerCharactersAll: {
    ...
    excludes: ['... your {type}/cost-filtered Characters OTHER THAN [X] cannot be K.O.\'d (needs filtered aura)'],
