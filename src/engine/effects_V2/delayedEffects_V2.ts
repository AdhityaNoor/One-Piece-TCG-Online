...
export interface DelayedEffectRecord_V2 {
  id: string;
...
export function createDelayedEffectRecord_V2(args: {
  effect: EffectDefinition_V2;
  duration: Duration_V2;
  sourceInstanceId: string;
  controllerId: string;
...
}): DelayedEffectRecord_V2 {
  return {
    id: `${args.sourceInstanceId}:delayed:${args.effect.id}:${args.turnNumber}:${args.existingCount}`,
